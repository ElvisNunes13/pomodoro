...
mixin _$PomodoroStore on _PomodoroStore, Store {
  late final _$contaPomodoroAtom =
      Atom(name: '_PomodoroStore.contaPomodoro', context: context);

  @override
  int get contaPomodoro {
    _$contaPomodoroAtom.reportRead();
    return super.contaPomodoro;
  }

  @override
  set contaPomodoro(int value) {
    _$contaPomodoroAtom.reportWrite(value, super.contaPomodoro, () {
      super.contaPomodoro = value;
    });
  }
  ...
  void contadorPomodoro() {
    final _$actionInfo = _$_PomodoroStoreActionController.startAction(
        name: '_PomodoroStore.contadorPomodoro');
    try {
      return super.contadorPomodoro();
    } finally {
